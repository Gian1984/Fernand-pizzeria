  ...
  const messages = {
    ...
    fr: {
      ...
      redpizzas:{
        ...
        Capricciosa:"Tomate, basilic, mozzarella, jambon cuit de haute qualité, champignons, olives noires et artichauts au four.",
      ...
      paninis:{
        ...
        Vegetariano:"Aubergines grillées, fromage provola fumé, roquette, tomates semi-séchées.",
        ...
        Cotto:"Jambon cuit de haute qualité, champignons sautés, fromage fontina..",
    ...
    en: {
      ...
      redpizzas:{
        ...
        Capricciosa:"Tomato, basil, mozzarella, high quality cooked ham, mushrooms, black olives and baked artichokes.",
      ...
      paninis:{
        ...
        Vegetariano:"Grilled aubergines, smoked provola cheese, rocket, semi-dried tomatoes.",
        ...
        Cotto:"High quality cooked ham, sautéed mushrooms, fontina cheese.",
    ...
    it: {
      ...
      redpizzas:{
        ...
        ProsciuttoFunghi:"Pomodoro, basilico, fior di latte, prosciutto cotto di alta qualità e funghi.",
        ...
        Capricciosa:"Pomodoro, basilico, fior di latte, prosciutto cotto di alta qualità, funghi, olive nere e carciofi al forno.",
      ...
      paninis:{
        ...
        Vegetariano:"Melanzane grigliate, provola affumicata, rucola, pomodori semi-dry.",
        ...
        Cotto:"Prosciutto cotto di alta qualità, funghi saltati, fontina.",
